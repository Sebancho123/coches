...
public class EditDatos extends javax.swing.JFrame {
    ...
    public EditDatos(Controladora control, int num_coche) {

        this.control = control;

        initComponents();
        cargarDatos(num_coche);
    }
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(btnGuardar, javax.swing.GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE)))))))
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (vali_parametros == true) {
            control.editAuto(auto, modelo, marca, motor, color, placa, cant_puertas);
            mensaje("Se edito correctamente", "info", "Exitoso");
            this.dispose();
            
            VerDatos verDatos = new VerDatos(control); 
    ...
    private void cargarDatos(int num_coche) {

        auto = control.findAuto(num_coche);
        ...
        txtCantPuer.setText(String.valueOf(auto.getCant_puertas()));
